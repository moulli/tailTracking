function tracking = boutsWrapper_manual(path_to_video, varargin)
...
%  - tracking [structure]: structure containing all the information.
    ...
    parameters.com1 = com1;
    parameters.vect0 = vect0;
    ...
    for i = 1:parameters.numframes
        ...
        im = readFrame(vid);
        im = mean(im, 3);
        segment_pts = segmentTracking_manual(im, com1, vect0, 'num_segments', parameters.num_segments, 'inertia', parameters.inertia, 'body_length', ...
                                             parameters.body_length, 'tail_length', parameters.tail_length, 'initial_box', parameters.initial_box,  ...
                                             'box_increment', parameters.box_increment);
